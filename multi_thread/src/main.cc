...
void final_scene(int image_width, int samples_per_pixel, int max_depth, int num_threads) {
...
void cornell_smoke(int num_threads) {
    hittable_list world;
...
void simple_light(int num_threads) {
    hittable_list world;
